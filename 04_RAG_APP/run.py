...
def check_env_config():
    ...
    if env_file.exists():
        ...
        logger.info("✅ 已加载根目录的.env配置文件")
    else:
        logger.warning("⚠️ 未找到根目录的.env文件，使用系统环境变量")
...
def check_data_files():
    """检查数据文件"""
    data_files = [
        "../02_User_Modeling/Product_IPA_Analysis/outputs/car_model_scores.csv",
        "../02_User_Modeling/User_Preference_Clustering/outputs/user_vector_matrix.csv"
    ]
